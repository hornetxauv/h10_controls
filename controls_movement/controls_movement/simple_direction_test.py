...
class DirectionTestNode(Node):
    def __init__(self, thruster_allocator_node, thruster_controller):
        ...
        self.thrusterController = thruster_controller
    ...
    def callback(self):
        ...
        thruster_pwm = self.thrusterAllocator.getTranslationPwm(Rotation).thrusts
...
def main(args=None):
    ...
    direction_test_node = DirectionTestNode(thruster_allocator_node, thruster_controller)
    ...
    try:
        ...
        thruster_controller.killThrusters()
    finally:
        thruster_controller.killThrusters()
