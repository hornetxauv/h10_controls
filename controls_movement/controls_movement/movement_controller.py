...
class MovementControllerNode(Node):
    ...
    def depth_callback(self, msg):
        self.depth_translation = msg.translation
        self.depth_rotation = msg.rotation
        self.update_movements()

    def goal_callback(self, msg):
        self.goal_translation = msg.translation
        self.goal_rotation = msg.rotation
        self.update_movements()
    
    def update_movements(self):
        self.translation = self.depth_translation + self.goal_translation # assuming depth and goal are independent, and goal does not contain a z factor
        self.rotation = self.depth_rotation + self.goal_rotation # assuming goal only has a yaw
